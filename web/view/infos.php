...
?>
    <section>
        ...
        <?php if (($_SESSION['type'] == "both") || ($_SESSION['type'] == "laique")) { ?>
            <article id="prieure">
                <h2 class="date">Samedi 19 Septembre 2020</h2>
                <h2 class="cere">Cérémonie Laïque et Réception</h2>

                <div>
                    <p>C’est au cœur de l’Anjou, que nous vous donnons rendez-vous pour y célébrer notre union et
        ...
        <?php if (($_SESSION['type'] == "both") || ($_SESSION['type'] == "civil")) { ?>
            <article id="mairie">
                ...
                <h2 class="date">22 Août 2020</h2>
                <h2 class="cere">La Cérémonie Civile</h2>
                <div>
                    <p>Vous êtes également invités à la cérémonie civile qui précédera notre joli week-end à la
